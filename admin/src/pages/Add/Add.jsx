...
const Add = ({url}) => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    if (response.data.success) {
      ...
      toast.success("Món ăn không được thêm thành công!");
    ...
    <div className='add'>
      <form className='flex-col' onSubmit={onSubmitHandler}>
        ...
        <div className="add-product-description flex-col">
          <p>Mô tả sản phẩm</p>
          <textarea onChange={onChangeHandler} value={data.description} name="description" rows="6" placeholder='Nhập nội dung mô tả'></textarea>
        </div>
        ...
        <div className="add-category-price">
          ...
          <div className="add-price flex-col">
            <p>Giá sản phẩm</p>
            <input onChange={onChangeHandler} value={data.price} type="number" name="price" placeholder="VD: 20.000 VNĐ" />
          </div>
