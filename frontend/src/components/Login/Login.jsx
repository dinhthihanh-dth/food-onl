    ...
    <div className='login-popup'>
      <form onSubmit={onLogin} className='login-popup-container'>
        ...
        <div className="login-popup-condition">
          ...
          <p>Bằng cách tiếp tục, bạn đồng ý với điều khoản sử dụng và chính sách bảo mật.</p>
        </div>
        {currState === "Đăng nhập"
          ? <p>Bạn chưa có tài khoản? <span onClick={() => setCurrState("Đăng ký")}>Nhấn vào đây</span></p>
          : <p>Bạn đã có tài khoản? <span onClick={() => setCurrState("Đăng nhập")}>Đăng nhập tại đây</span></p>
        }
      </form>
    </div>
  )
